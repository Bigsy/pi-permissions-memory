 ...
 * @param hasSession - True when the user chose "for this session".
 * @param canConfirm - Whether an interactive prompt was available.
 * @param hasGlobal - True when the user chose global approval.
 */
export function deriveResolution(
  ...
  if (action === "allow") {
    ...
    if (hasGlobal) return "user_approved_globally";
