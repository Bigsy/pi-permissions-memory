...
import { approveGlobalRule as writeGlobalApproval } from "./global-approvals";
...
export class PermissionSession {
  ...
  approveGlobalRule(surface: string, pattern: string): void {
    writeGlobalApproval(this.paths.agentDir, surface, pattern);
  }
